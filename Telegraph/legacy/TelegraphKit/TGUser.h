...
//qi.zhang add
typedef enum {
    TGUserNationUnknown = 0,
    TGUserNationChinese = 1,
    TGUserNationOther = 2
} TGUserNations;
//
...
//qi.zhang add
@property (nonatomic) TGUserNations nation;
@property (nonatomic, strong) NSString *checkedFirstName;
@property (nonatomic, strong) NSString *checkedLastName;
//
