...
- (instancetype)initWithMessage:(TGMessage *)message contact:(TGUser *)contact author:(TGUser *)author context:(TGModernViewContext *)context
{
    ...
    if (self != nil)
    {
        ...
        dispatch_once(&onceToken1, ^
        {
            ...
            outgoingDateColor = UIColorRGBA(0xffffff, 0.8f);
...
//            incomingForwardColor = UIColorRGBA(0x007bff, 1.0f);
            incomingForwardColor = UIColorRGBA(0x000000, 1.0f);
            outgoingForwardColor = UIColorRGBA(0xffffff, 0.8f);
        ...
        _contactPhoneModel = [[TGModernLabelViewModel alloc] initWithText:[TGPhoneUtils formatPhone:contact.phoneNumber forceInternational:contact.uid != 0] textColor:_incoming ? [UIColor blackColor] : [UIColor whiteColor] font:[assetsSource messageForwardPhoneFont] maxWidth:155.0f];
        ...
        _dateModel = [[TGModernDateViewModel alloc] initWithText:dateText textColor:_incoming ? incomingDateColor : outgoingDateColor daytimeVariant:daytimeVariant message:message];
...
//            outgoingForwardColor = UIColorRGBA(0x00a516, 1.0f);
            outgoingForwardColor = UIColorRGBA(0xffffff, 1.0f);
