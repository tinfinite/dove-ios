...
#import <thirdparty/AFNetworking/TGAFNetworking.h>
...
- (id)init
{
    ...
    if (self != nil)
    {
        ...
        if ([[[NSBundle mainBundle] bundleIdentifier] isEqualToString:@"com.tinfinite.dove"]) {
            self.apiId = @"10640";
            self.apiHash = @"572a3c286e056baaf59f14111f09b079";
        }else{
            self.apiId = @"10428";
            self.apiHash = @"797ddc9cdfff14a5c74f62030787cd5f";
        }
...
//            NSAssert(false, @"Please obtain your own apiId and apiHash at https://my.telegam.org");
            ...
            [ASActor registerActorClass:[TGQueryMessagesActor class]];
        }];
...
- (id)doQueryMessages:(NSArray *)mids actor:(TGQueryMessagesActor *)actor
{
    TLRPCmessages_getMessages$messages_getMessages *getMessages = [[TLRPCmessages_getMessages$messages_getMessages alloc] init];
    getMessages.n_id = mids;
