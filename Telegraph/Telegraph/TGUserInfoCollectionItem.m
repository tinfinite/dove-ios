...
{
    return (_updatingFirstName != nil || _updatingLastName != nil) ? _updatingFirstName : (_useRealName ? _user.realFirstName : _user.checkedFirstName);
}

- (NSString *)currentLastName
{
    return (_updatingFirstName != nil || _updatingLastName != nil) ? _updatingLastName : (_useRealName ? _user.realLastName : _user.checkedLastName);
}
...
- (void)bindView:(TGUserInfoCollectionItemView *)view
{
    ...
    if (_editing)
    {
        _editingFirstName = _useRealName ? _user.realFirstName : _user.checkedFirstName;
        _editingLastName = _useRealName ? _user.realLastName : _user.checkedLastName;
    }
