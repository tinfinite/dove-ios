...
- (void)layoutSubviews
{
    ...
    _switchView.frame = CGRectMake(bounds.size.width - switchSize.width - 15.0f, (bounds.size.height - switchSize.height)/2, switchSize.width, switchSize.height);
    
    _titleLabel.frame = CGRectMake(15.0f, CGFloor((bounds.size.height - 26.0f) / 2.0f), bounds.size.width - 35.0f - 4.0f - switchSize.width - 6.0f, 26.0f);
}
