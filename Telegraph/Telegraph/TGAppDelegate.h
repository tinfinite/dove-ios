...
//#define PublishChannel @"fir.im"
#define PublishChannel @""
...
@property (nonatomic) bool autoGesturePassword;
...
@property (nonatomic, strong) TGGroupDialogListViewController *groupDialogListController;
@property (nonatomic, strong) TGSingleChatListController *singleDialogListController;
@property (nonatomic, strong) TGNodeStreamController *nodeStreamController;
@property (nonatomic, strong) TGContactsController *contactsController;
@property (nonatomic, strong) TGMeController *meController;
