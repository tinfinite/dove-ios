...
- (void)drawRect:(CGRect)rect
{
    ...
    if (selected) {
        if (success) {
            CGContextSetRGBStrokeColor(context, 118/255.f, 200/255.f, 76/255.f,1);//线条颜色
            CGContextSetRGBFillColor(context,118/255.f, 200/255.f, 76/255.f,1);
        }
        else {
    ...
    if (success) {
        CGContextSetRGBFillColor(context,118/255.f, 200/255.f, 76/255.f,0.3f);
    }
    else {
        CGContextSetRGBFillColor(context,208/255.f, 36/255.f, 36/255.f,0.3f);
    }
    CGContextAddEllipseInRect(context,frame);
    if (selected) {
        CGContextFillPath(context);
