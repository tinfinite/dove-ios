...
- (UIImage *)playImage:(bool)incoming
{
    ...
    dispatch_once(&onceToken, ^
    {
        ...
        outgoingImage = playImageWithColor(UIColorRGB(0xffffff));
    });
...
- (UIImage *)pauseImage:(bool)incoming
{
    ...
    dispatch_once(&onceToken, ^
    {
        ...
        outgoingImage = pauseImageWithColor(UIColorRGB(0xffffff));
    });
...
- (UIImage *)downloadImage:(bool)incoming
{
    ...
    dispatch_once(&onceToken, ^
    {
        ...
        outgoingImage = downloadImageWithColor(UIColorRGB(0xffffff));
    });
...
- (UIImage *)cancelImage:(bool)incoming
{
    ...
    dispatch_once(&onceToken, ^
    {
        ...
        outgoingImage = cancelImageWithColor(UIColorRGB(0xffffff), false);
    });
