...
static const CGFloat timestampWidth = 130.0f;    //qi.zhang modify,to show points
...
- (void)_updateTimestampViewFrame
{
    ...
    else if (_timestampPosition == TGMessageImageViewTimestampPositionImageVote)
    {
        _timestampView.frame = CGRectMake(self.frame.size.width - timestampWidth - timestampRightPadding - 35, self.frame.size.height - timestampHeight - timestampBottomPadding, timestampWidth, timestampHeight);
    }
}
