...
//            dotsColor = [UIColor colorWithRed:0 green:123.0f / 255.0f blue:255.0f / 255.0f alpha:(radius * deltaAlpha + minAlpha)];
            dotsColor = [UIColor colorWithRed:1 green:255.0f / 255.0f blue:255.0f / 255.0f alpha:(radius * deltaAlpha + minAlpha)];
...
//            CGFloat color[4] = {0.0f, 123.0f / 255.0f, 1.0f, 1.0f};
            CGFloat color[4] = {1.0f, 1.0f, 1.0f, 1.0f};   //qi.zhang modify
