...
//    CGSize titleFirstSize = [_titleFirst sizeWithFont:titleFirstFont];
    //qi.zhang modify
    CGSize titleFirstSize = [_titleFirst sizeWithAttributes:[NSDictionary dictionaryWithObject:titleFirstFont forKey:UITextAttributeFont]];
...
//    CGSize titleSecondSize = [_titleSecond sizeWithFont:titleSecondFont];
    //qi.zhang modify
    CGSize titleSecondSize = [_titleSecond sizeWithAttributes:[NSDictionary dictionaryWithObject:titleSecondFont forKey:UITextAttributeFont]];
