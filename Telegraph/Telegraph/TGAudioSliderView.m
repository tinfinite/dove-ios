...
- (UIImage *)trackImage:(bool)incoming
{
    ...
    dispatch_once(&onceToken, ^
    {
        ...
        outgoingImage = [self trackImageWithColor:UIColorRGBA(0xffffff,0.3f)];
    });
...
- (UIImage *)trackForegroundImage:(bool)incoming
{
    ...
    dispatch_once(&onceToken, ^
    {
        ...
        outgoingImage = [self trackImageWithColor:UIColorRGB(0xffffff)];
    });
...
- (UIImage *)thumbImage:(bool)incoming
{
    ...
    dispatch_once(&onceToken, ^
    {
        ...
        outgoingImage = [self thumbImageWithColor:UIColorRGB(0xffffff)];
    });
...
- (UIColor *)durationColor:(bool)incoming
{
    ...
    dispatch_once(&onceToken, ^
    {
        ...
        outgoingColor = UIColorRGBA(0xffffff, 0.8f);
    });
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self)
    {
        ...
        [_sliderButton setColor:_incoming ? TGAccentColor() : UIColorRGB(0xffffff)];
