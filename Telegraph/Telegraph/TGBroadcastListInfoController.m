...
- (void)addParticipantPressed
{
    ...
    //qi.zhang modify from white navbar to super navbar
    TGNavigationController *navigationController = [TGNavigationController navigationControllerWithControllers:@[controller] navigationBarClass:[TGNavigationBar class]];
    if ([self inPopover])
    {
