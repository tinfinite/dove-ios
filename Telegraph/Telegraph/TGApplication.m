...
{
    return [self openURL:url forceNative:forceNative withParentVC:TGAppDelegateInstance.mainNavigationController];
}

- (BOOL)openURL:(NSURL *)url forceNative:(BOOL)forceNative withParentVC:(UINavigationController *)nav
{
    ...
    {
        TGWebViewController *webController = [[TGWebViewController alloc] initWithUrl:[url absoluteString] andType:WebViewControllerTypeNormal];
        [nav pushViewController:webController animated:true];
        return true;
    }
