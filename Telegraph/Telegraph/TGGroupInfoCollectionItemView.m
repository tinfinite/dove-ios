...
- (id)initWithFrame:(CGRect)frame
{
    ...
    {   
        ...
        _descriptionLabel.font = TGSystemFontOfSize(15);
...
- (void)layoutSubviews
{
    ...
    CGSize descriptionSize = [_descriptionLabel sizeThatFits:CGSizeMake(maxTitleWidth, CGFLOAT_MAX)];
    if (descriptionSize.height < FLT_EPSILON) {
        ...
        titleSize.width = MIN(titleSize.width, maxTitleWidth);
        CGRect titleLabelFrame = CGRectMake(92, 17, titleSize.width, titleSize.height);
        
        _titleLabel.frame = titleLabelFrame;
        _titleField.frame = CGRectMake(titleLabelFrame.origin.x, titleLabelFrame.origin.y, maxTitleWidth, titleLabelFrame.size.height);
        
        CGSize descriptionSize = [_descriptionLabel sizeThatFits:CGSizeMake(maxTitleWidth, CGFLOAT_MAX)];
        _descriptionLabel.frame = CGRectMake(titleLabelFrame.origin.x, titleLabelFrame.origin.y + titleLabelFrame.size.height + 5, maxTitleWidth, descriptionSize.height);
    }
